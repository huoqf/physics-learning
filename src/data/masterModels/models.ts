...
export const masterModels: MasterModel[] = [
  ...
  },
  {
    ...
    summary: '平抛斜面落点、斜抛最远射程与偏角倍数定理。核心思想：沿水平/竖直正交分解或沿斜面/垂直斜面正交分解。',
    knowledgeId: 'mechanics-5-2',
    knowledgeIds: ['mechanics-5-2', 'mechanics-5-3'],
    animId: 'anim-projectile',
    secondaryAnimId: 'anim-oblique-throw',
    presetParams: { v0x: 10, g: 9.8, airResistance: 0 },
    secondaryPresetParams: { v0: 20, angle: 45, g: 9.8, advancedMode: 0 },
    quickFormula: {
      title: '偏角倍数定理与斜抛最大射程',
      latex: '\\tan\\theta = 2\\tan\\alpha, \\quad X_{\\text{max}} = \\frac{v_0^2 \\sin 2\\theta}{g}',
      explanation: '① 抛体运动中速度偏角正切值恒等于位移偏角正切值的 2 倍 (tanθ = 2tanα)；② 斜抛初速度一定时，抛射角 θ = 45° 取得最大射程，互余角 (如 30° 与 60°) 射程相等。',
    },
    examTips: [
