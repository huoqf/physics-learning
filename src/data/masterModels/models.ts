...
export const masterModels: MasterModel[] = [
  ...
  },
  {
    ...
    animId: 'anim-conveyor-belt',
    presetParams: { v_belt: 4, mu: 0.3, L: 8 },
    quickFormula: {
      title: '共速位移与划痕长度',
  ...
  },
  {
    ...
    animId: 'anim-projectile-motion',
    presetParams: { v0: 10, angle: 45 },
    quickFormula: {
      title: '斜面平抛落点与垂直击中条件',
  ...
  },
  {
    ...
    animId: 'anim-circular-motion',
    presetParams: { R: 2, v0: 6 },
    quickFormula: {
      title: '绳/拱桥模型最高点临界速度',
  ...
  },
  {
    ...
    knowledgeId: 'mechanics-5-6',
    animId: 'anim-gravitational-orbit',
    presetParams: { h: 400 },
    quickFormula: {
      title: '第一宇宙速度与双星系统周期',
  ...
  },
  {
    ...
    animId: 'anim-momentum-collision',
    presetParams: { m1: 1, m2: 2, v1: 6 },
    quickFormula: {
      title: '完全弹性碰撞末速度公式',
  ...
  },
  {
    ...
    title: '12. 带电粒子在交变电场中的运动',
    category: 'electromagnetism',
    frequencyBadge: '高考5年7考 / 压轴选择与大题',
    summary: '带电粒子在方波/正弦交变电场中的往复运动与偏转。核心法：绘制 v-t 图象分析位移与分段轨迹。',
    knowledgeId: 'electricity-2-3',
    animId: 'anim-alternating-field',
    presetParams: { E0: 100, T: 2 },
    quickFormula: {
      title: '交变电场最大偏转位移',
      latex: 'a = \\frac{q E_0}{m}, \\quad y_{\\max} = 2 \\cdot \\left(\\frac{1}{2} a \\left(\\frac{T}{2}\\right)^2\\right) = \\frac{q E_0 T^2}{4 m}',
      explanation: '通过 v-t 图象面积计算粒子在半周期内的加速度与位移，判断粒子能否穿过极板。',
    },
    examTips: [
      '粒子进入交变电场的时刻不同，运动轨迹与离开电场时的速度方向截然不同，需分类讨论进入相位。',
    ],
    relatedProblemIds: [],
  },
  {
    ...
    knowledgeId: 'electricity-3-5',
    animId: 'anim-cyclotron-magnetic',
    presetParams: { B: 1.2, R_box: 0.5 },
    quickFormula: {
  ...
  },
  {
    ...
    animId: 'anim-transformer-model',
    presetParams: { U1: 220, n1: 1100, n2: 55 },
    quickFormula: {
      title: '理想变压器与输电线功率损耗',
  ...
  },
  {
    ...
    summary: '弹簧振子/单摆简谐运动与横波传播。核心突破点：“一图看质点（y-t），一图看波形（y-x）”，抓住波的多解性。',
  ...
  },
  {
    ...
    animId: 'anim-total-internal-reflection',
    presetParams: { n: 1.5 },
    quickFormula: {
      title: '折射定律与全反射临界角',
  ...
  },
  {
    ...
    animId: 'anim-photoelectric-effect',
    presetParams: { W0: 2.2, hnu: 3.5 },
    quickFormula: {
      title: '光电效应方程与最大初动能',
