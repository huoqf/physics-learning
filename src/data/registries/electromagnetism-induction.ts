...
export const electromagnetismInductionAnimations = defineAnimations({
  ...
  'anim-induction-single-rod': {
    ...
    controlMeta: [
      {
        type: 'preset',
        label: '📋 2023全国甲卷（单杆恒力收尾）',
        description: 'F=1.2N, B=1.0T, R=1.5Ω, m=0.2kg, L=0.8m',
        params: { startMechanism: 0, driveForce: 1.2, magneticB: 1.0, resistance: 1.5, rodMass: 0.2, railSpacing: 0.8 },
        restartOnApply: true,
      },
      {
        type: 'preset',
        label: '📋 高考临界预设（阻尼切割）',
        description: 'v₀=5m/s, B=1.2T, R=1.0Ω, m=0.2kg, L=0.8m',
        params: { startMechanism: 1, initialVelocity: 5.0, magneticB: 1.2, resistance: 1.0, rodMass: 0.2, railSpacing: 0.8 },
        restartOnApply: true,
      },
      {
        type: 'segmented',
    ...
    paramMeta: [
      { key: 'driveForce', label: '恒定外力 F', min: 0.2, max: 5.0, step: 0.1, unit: 'N', showIf: 'startMechanism', showIfValue: 0 },
      {
        ...
        step: 0.1,
        unit: 'm/s',
        showIf: 'startMechanism',
        showIfValue: 1,
        marks: [{ value: 5.0, label: '推荐 v0=5m/s', variant: 'recommended' }],
      },
      {
        key: 'magneticB',
        label: '磁感应强度 B',
        ...
        unit: 'T',
        marks: [
          { value: 1.0, label: '推荐 1.0T' },
          { value: 1.5, label: '临界: 强磁场收尾', variant: 'critical' },
        ],
      },
  ...
  'anim-induction-dual-rods': {
    ...
    controlMeta: [
      {
        type: 'preset',
        label: '📋 2022全国乙卷（双杆动量守恒）',
        description: 'ma=0.2kg, mb=0.4kg, B=1.0T, L=0.5m, v0=6m/s',
        params: { scenario: 0, massA: 0.2, massB: 0.4, fieldB: 1.0, railL: 0.5, resSum: 1.0, initialV0: 6.0 },
        restartOnApply: true,
      },
      {
        type: 'segmented',
    ...
    paramMeta: [
      ...
      { key: 'resSum', label: '总电阻 R_a+R_b', min: 0.2, max: 3.0, step: 0.1, unit: 'Ω', group: '质量与回路' },
      {
        ...
        showIf: 'scenario',
        showIfValue: 0,
        marks: [{ value: 6.0, label: '高考预设 6m/s', variant: 'recommended' }],
      },
