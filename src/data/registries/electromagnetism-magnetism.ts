...
export const electromagnetismMagnetismAnimations = defineAnimations({
  ...
  'anim-magnetic-circular-geom': {
    title: '磁场圆周几何模型',
    knowledgeId: 'electricity-3-3-geom',
    Component: lazy(() => import('@/features/electromagnetism/magnetism/CircularGeometryModel/CircularGeometryModel')),
    CenterExtra: lazy(() => import('@/features/electromagnetism/magnetism/CircularGeometryModel/CircularGeometryModelExtra')),
    centerLayout: 'splitH',
    controlsMode: 'timed' as const,
    controlMeta: [
      { type: 'segmented', key: 'boundaryType', label: '磁场边界', group: '模型选择', resetOnChange: true,
        options: [{ value: 0, label: '单边界' }, { value: 1, label: '矩形边界' }, { value: 2, label: '圆形边界' }] },
      { type: 'segmented', key: 'particleSign', label: '电荷电性', group: '模型选择', resetOnChange: true,
        options: [{ value: 1, label: '正电荷 (+q)' }, { value: -1, label: '负电荷 (-q)' }] },
      { type: 'toggle', key: 'step1_showPerp', label: '1. 绘制速度垂线', group: '解题专项工具箱' },
      { type: 'toggle', key: 'step2_showCenter', label: '2. 锁定交点圆心 O', group: '解题专项工具箱' },
      { type: 'toggle', key: 'step3_lockTriangle', label: '3. 显化几何直角三角形', group: '解题专项工具箱' },
      { type: 'action', label: '发射粒子', variant: 'primary', action: 'restart', group: '控制轴' },
      { type: 'action', label: '重置轨迹', variant: 'secondary', action: 'reset', group: '控制轴' },
      { type: 'tip', group: '教学提示',
        content: '物理高考核心方法：先用速度垂线交点锁定圆心 O，再高亮紫色特征直角三角形进行几何代数计算。' },
    ],
    defaultParams: {
      boundaryType: 0,
      particleSign: 1,
      ...
      step1_showPerp: 1,
      step2_showCenter: 0,
      step3_lockTriangle: 0,
    } as const,
    paramMeta: [
      { key: 'velocity', label: '初速度 v', min: 1.0, max: 5.0, step: 0.1, unit: 'm/s' },
      { key: 'angle', label: '入射角 α', min: 0, max: 180, step: 1, unit: '°' },
      { key: 'magneticB', label: '磁场强度 B', min: 0.2, max: 2.0, step: 0.1, unit: 'T' },
    ],
  },
})
