...
export const electromagnetismElectrostaticsAnimations = defineAnimations({
  'anim-coulomb-law': {
    ...
    defaultParams: { q1: 2, q2: -3, r: 4, mode: 0, showForceAnalysis: 0, L: 20, m: 0.05 },
    paramMeta: [
      ...
      { key: 'L', label: '丝线长度 L', min: 10, max: 40, step: 1, unit: 'cm', showIf: 'mode', showIfValue: 1 },
      { key: 'm', label: '小球质量 m', min: 0.01, max: 0.2, step: 0.01, unit: 'kg', showIf: 'mode', showIfValue: 1 },
    ],
