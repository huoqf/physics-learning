...
export const electromagnetismElectrostaticsAnimations = defineAnimations({
  ...
  'anim-electrostatic-shielding': {
    title: '静电平衡与静电屏蔽',
    knowledgeId: 'electricity-1-8',
    Component: lazy(() => import('@/features/electromagnetism/electrostatics/electrostatic-shielding')),
    controlsMode: 'param',
    defaultParams: {
      E0: 200,
      mode: 0,
    ...
    controlMeta: [
      {
        type: 'preset',
        label: '📋 高考真题：验电器金属网罩屏蔽实验',
        group: '快捷预设',
        params: () => ({ E0: 300, mode: 2, isGrounded: 0, showFieldLines: 1, tipRadius: 1.0 }),
      },
      {
        type: 'preset',
        label: '📋 避雷针尖端微粒放电 (R=0.2mm)',
        group: '快捷预设',
        params: () => ({ E0: 450, mode: 1, isGrounded: 1, showFieldLines: 1, tipRadius: 0.2 }),
      },
      {
        type: 'segmented',
        key: 'mode',
        ...
        resetOnChange: true,
        options: [
          { value: 0, label: '静电平衡与内部零场' },
          { value: 1, label: '尖端放电' },
          { value: 2, label: '空腔静电屏蔽' },
        ],
      },
      {
        type: 'toggle',
      ...
      },
      {
        ...
        group: '核心考点',
        variant: 'primary',
        content: '【静电平衡判定】：自由电子停止定向移动时，内部感应电场 E\' 与外电场 E0 严格等大反向，导体内合场强处处为零，整个导体为等势体。',
      },
    ],
    paramMeta: [
      { key: 'E0', label: '外加电场 E0', min: 50, max: 500, step: 25, unit: 'V/m' },
      {
        key: 'tipRadius',
        label: '尖端曲率半径 R',
        min: 0.2,
        ...
        showIf: 'mode',
        showIfValue: 1,
        marks: [{ value: 0.2, label: '极尖锐', variant: 'critical' }],
      },
    ],
  },
})
