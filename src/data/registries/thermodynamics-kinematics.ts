...
export const thermodynamicsKinematicsAnimations = defineAnimations({
  'anim-brownian-motion': {
    ...
    paramMeta: [
      ...
      { key: 'inputValue', label: '估算输入值', min: 1, max: 200, step: 1, unit: 'g/cm³', group: '微观估算设置' },
    ],
    controlMeta: [
      ...
      { type: 'segmented', key: 'substanceIdx', label: '估算物质', group: '微观估算设置',
        options: [{ value: 0, label: '水' }, { value: 1, label: '金' }, { value: 2, label: '铁' }, { value: 3, label: '铜' }, { value: 4, label: '氧气' }] },
      { type: 'segmented', key: 'inputMode', label: '量纲模式', group: '微观估算设置',
        options: [{ value: 0, label: '质量 g' }, { value: 1, label: '体积 cm³' }] },
      { type: 'tip', group: '教学提示', showIf: 'mode', showIfValue: 1,
        content: '蓝色小球为液体分子，橙色箭头为瞬间碰撞合力。' },
    ],
