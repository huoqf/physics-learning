  ...
  steps: [
    {
      ...
      scorePoints: 4,
      formula:
        '$$\\begin{aligned} a_m &= \\mu_1 g = 0.3 \\times 10 = 3\\,\\text{m/s}^2 \\\\[4pt] a_M &= \\frac{\\mu_1 mg - \\mu_2 (m+M)g}{M} = \\frac{0.3 \\times 10 - 0.05 \\times 40}{3} \\approx 0.33\\,\\text{m/s}^2 \\end{aligned}$$',
    ...
    },
    {
      ...
      scorePoints: 3,
      formula:
        '$$\\begin{aligned} v_0 - a_m t &= a_M t \\implies 5 - 3t = \\frac{1}{3}t \\\\[4pt] t &= 1.5\\,\\text{s}, \\quad v_{\\text{共}} = 0.5\\,\\text{m/s} \\end{aligned}$$',
    ...
    },
    {
      ...
      scorePoints: 3,
      formula:
        '$$\\begin{aligned} \\Delta x &= x_m - x_M = \\frac{v_0 + v_{\\text{共}}}{2}t - \\frac{v_{\\text{共}}}{2}t = \\frac{v_0}{2}t \\\\[4pt] \\Delta x &= \\frac{5}{2} \\times 1.5 = 3.75\\,\\text{m} > L = 2.5\\,\\text{m} \\end{aligned}$$',
