...
import { buildLightRodRopeQuantities } from './energyCases/lightRodRope'
import { buildVerticalSpringQuantities } from './energyCases/verticalSpring'
...
export function buildEnergyQuantities(
  ...
  switch (animId) {
    ...
    case 'anim-vertical-spring':
      return buildVerticalSpringQuantities(params, time, base)

    case 'anim-light-rod-rope':
      return buildLightRodRopeQuantities(params, time, base)
