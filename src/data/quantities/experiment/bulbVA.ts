...
export function buildBulbVAQuantities(
  ...
  return {
    ...
    gaokaoPoints: [
      ...
      {
        text: '【图线弯曲与电阻变化】随电压升高，电功率增大，灯丝温度升高，金属电阻率增大，导致灯丝电阻随电压升高而变大。在 I-U 图象中（横轴为 U，纵轴为 I），割线斜率 k = I/U = 1/R 随电压升高而减小，图线向电压横轴偏折（向下弯曲、越来越平缓）；而在 U-I 图象中（横轴为 I，纵轴为 U），斜率才直接表示电阻 R，图线才会向上弯曲（越来越陡）。高考常考两类坐标轴辨析，审题务必先看清横纵轴！',
        importance: 'core',
      },
      {
