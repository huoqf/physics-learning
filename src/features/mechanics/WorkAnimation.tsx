    ...
    <div ref={containerRef} className="w-full h-full">
      <svg width={canvasSize.width} height={canvasSize.height} className="bg-white rounded-lg shadow-inner">
        ...
        <g transform={`translate(${blockX}, ${groundY - objH + floatOffset})`}>
          ...
          <line x1={objW * 0.15} y1={objH * 0.15} x2={objW * 0.22} y2={objH * 0.45} stroke={colors.neutral[0]} strokeWidth={1} opacity={0.6} />
          <line x1={objW * 0.45} y1={objH * 0.15} x2={objW * 0.52} y2={objH * 0.45} stroke={colors.neutral[0]} strokeWidth={1} opacity={0.6} />
          {/* 装饰条 */}
