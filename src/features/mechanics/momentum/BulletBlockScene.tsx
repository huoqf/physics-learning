...
export default function BulletBlockScene({
  ...
  return (
    <g>
      ...
      {/* 速度矢量 — 子弹 */}
      <VectorArrow
        origin={{ x: state.bulletX, y: BB_LAYOUT.bulletRadius / sceneScale.scaleY }}
      ...
      {/* 速度矢量 — 木块 */}
      <VectorArrow
        origin={{ x: state.blockX + param.L / 2, y: BB_LAYOUT.blockHeight / sceneScale.scaleY }}
      ...
      {inContact && state.bulletA !== 0 && (
        <VectorArrow
          origin={{ x: state.bulletX, y: BB_LAYOUT.bulletRadius / sceneScale.scaleY + 0.02 }}
      ...
      {inContact && state.blockA !== 0 && (
        <VectorArrow
          origin={{ x: state.blockX + param.L / 2, y: BB_LAYOUT.blockHeight / sceneScale.scaleY + 0.02 }}
