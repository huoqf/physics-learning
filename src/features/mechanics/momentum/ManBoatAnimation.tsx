import { PhysicsVectorArrow, PhysicsGround, SVGSingleBar } from '@/components/Physics'
            ...
            {(() => {
              ...
              return (
                <g>
                  ...
                  <PhysicsVectorArrow originDesign={{ x: boatState.x_person1, y: 0.85 }} vector={{ x: boatState.v_person1, y: 0 }} type="velocityX" sceneScale={sceneScale} />
                </g>
              )
            })()}
            ...
            {isDouble && (() => {
              ...
              return (
                <g>
                  ...
                  <PhysicsVectorArrow originDesign={{ x: boatState.x_person2, y: 0.85 }} vector={{ x: boatState.v_person2, y: 0 }} type="velocityY" sceneScale={sceneScale} />
                </g>
              )
            })()}

            {/* 船速度箭头 */}
            <PhysicsVectorArrow originDesign={{ x: boatState.x_boat + L_boat * 0.5, y: 0.4 }} vector={{ x: boatState.v_boat, y: 0 }} type="velocity" sceneScale={sceneScale} />
