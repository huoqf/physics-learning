            ...
            <>
              ...
              {r <= 20 && (
                <g>
                  ...
                  {/* 顶点标记 */}
                  <circle cx={toPrX(r)} cy={toPrY(P_max)} r={1.0} fill={CHART_COLORS.criticalPt} />
                  <text x={toPrX(r)} y={toPrY(P_max) - 2.5} fontSize={font(2.4)} fill={CHART_COLORS.criticalPt} fontWeight="bold" textAnchor="middle">
