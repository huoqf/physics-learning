...
> 最后更新：2026-06-29（fontSize 响应式缩放 D 类迁移完成）
...
- **A 类** SVG fontSize 裸值：✅ 8 文件已全部迁移（力学 3 + 电磁学 5）。**D 类** 11 文件已迁移（公共物理组件 7 + Spring 相关 4）。剩余 B 类 11 文件（subcomponent 需加 font prop）+ C 类 2 文件（混合残留），详见 [`FONT_SIZE_AUDIT.md`](./FONT_SIZE_AUDIT.md)
