...
- **D 类** useCanvasSize → CANVAS_PRESETS：已迁移 65/76 调用点（原 7/76），剩余 11 为占位符/紧凑子场景/唯一尺寸/动态传入，不建议替换。新增 `mediumWide: 650×400` preset。详见 [`CANVAS_PRESETS_AUDIT.md`](./CANVAS_PRESETS_AUDIT.md)
